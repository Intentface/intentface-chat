...
export const textareaAttrs = [
  ...
  { attribute: 'data-slot="command-hint"', description: "The badge's hint element — ghost-text completion of the highlighted item, or the empty-query placeholder. A real span: style it like any other slot." },
];
