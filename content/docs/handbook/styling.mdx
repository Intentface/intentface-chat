...
Attributes tables on [Composer](/docs/primitives/composer),
[Message](/docs/primitives/message), [Thread](/docs/primitives/thread), and the
rest.
...
your components — see [Composition](/docs/handbook/composition).
