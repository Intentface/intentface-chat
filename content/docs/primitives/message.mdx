...
import { Chips } from './message/demos/chips';
import { Selection } from './message/demos/selection';
...
<Demo component={<Chips />} file="primitives/message/demos/chips.tsx" />
...
<Demo component={<Selection />} file="primitives/message/demos/selection.tsx" />
