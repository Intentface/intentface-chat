...
collapsed/expanded state and the relationship.
...
The disclosure root. Renders `data-slot="reasoning"`.
...
export const rootAttrs = [
  { attribute: "data-slot", values: '"reasoning"', description: "The disclosure root." },
...
The toggle. Renders a `<button>` with `data-slot="reasoning-trigger"`. Without
...
export const triggerAttrs = [
  { attribute: "data-slot", values: '"reasoning-trigger"', description: "The toggle button." },
  { attribute: "data-open", description: "Present while open." },
  { attribute: "data-closed", description: "Present while closed." },
];
...
The collapsible panel. Renders `data-slot="reasoning-content"`. Bold `**Header**`
...
export const contentAttrs = [
  { attribute: "data-slot", values: '"reasoning-content"', description: "The panel." },
  { attribute: "data-open", description: "Present while open." },
  { attribute: "data-closed", description: "Present while closed." },
