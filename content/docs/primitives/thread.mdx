...
export const rootAttrs = [
  { attribute: "data-slot", values: '"thread-root"', description: "The root element." },
...
export const viewportAttrs = [
  ...
  { attribute: "data-slot", values: '"thread-top"', description: "The 1px at-top sentinel the IntersectionObserver watches." },
