...
export const rootProps = [
  ...
  { name: "commands", type: "ComposerCommandsMap", default: "{}", description: "Prefix → command config (kind, trigger, items, suggestion). Drives the command lists; suggestion: false disables the ghost-text completion for that prefix." },
...
export const textareaAttrs = [
  ...
  { attribute: "data-command-suggestion", description: "On the active-token badge while the highlighted item can complete the query — render it as ghost text via ::after content." },
];
