...
const TooltipArrow = ({ ...props }: TooltipPrimitive.Arrow.Props) => {
  return (
    <TooltipPrimitive.Arrow data-slot="tooltip-arrow" {...props}>
    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            "data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-[state=delayed-open]:animate-in data-[state=delayed-open]:fade-in-0 data-[state=delayed-open]:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 rounded-md px-2 py-1 text-xs data-[side=inline-start]:slide-in-from-right-2 data-[side=inline-end]:slide-in-from-left-2 bg-primary-bg border border-primary-border text-ink-primary z-50 w-fit max-w-xs origin-(--transform-origin)",
            className,
          )}
          {...props}
        >
