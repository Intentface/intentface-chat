...
`className`, `style`, and a `render` prop. See [Styling](/docs/handbook/styling).
...
- [Quick start](/docs/quick-start) — install the package and assemble a chat
- [Build a chat](/docs/build-a-chat) — the same result in four stages
- [Accessibility](/docs/handbook/accessibility) — what the primitives wire up, and what you supply
