...
export const ArtifactCard = ({
  ...
  return (
    <motion.button
      ...
      className={cn(
        "flex w-full cursor-pointer items-center gap-3 rounded-xl border border-slate-7 bg-primary px-4 py-3 text-left transition-colors shadow-xs",
        "hover:bg-primary-hover disabled:cursor-default disabled:opacity-70",
        className,
      )}
      {...props}
    >
