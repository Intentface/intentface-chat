...
Validation emits a structured `AttachmentErrorCode` (`"accept"`,
`"max_file_size"`, `"max_files"`) on the composer's attachments state — you map
codes to your own (localized) copy; the package ships no messages.
