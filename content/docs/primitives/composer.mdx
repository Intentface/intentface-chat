...
Focus proxy and layout frame. Renders `data-composer-container`
...
`data-composer-attachment-trigger`. No part-specific props.
...
One selectable row. Renders `data-composer-command-item`.
